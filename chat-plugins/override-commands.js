...
exports.commands = {
	...
	join: function (target, room, user, connection) {
		...
		let blacklist = ["dhcp-077-250-225-247.chello.nl", "c-76-100-209-92.hsd1.md.comcast.net", "zenmate",
			...
			"122.162.78.223", "abts-north-dynamic-223.78.162.122.airtelbroadband.in", "71.207.119.61", "c-71-207-119-61.hsd1.pa.comcast.net", "122.162.133.188", "35.164.25.76", "93.44.65.147", "abts-north-dynamic-188.133.162.122.airtelbroadband.in", "24.45.243.211"
		];
		for (let i = 0; i < blacklist.length; i++) {
			if (user.latestHost.indexOf(blacklist[i]) > -1 || user.latestIp.indexOf(blacklist[i]) > -1) {
				user.popup('You are on the Sora League banlist or are using a Proxy. God bless.');
				user.disconnectAll();
			}
		}
	},
