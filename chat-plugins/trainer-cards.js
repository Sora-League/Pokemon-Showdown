...
exports.commands = {
	...
	onyx: function (target, room, user) {
		if (!this.runBroadcast()) return;
		this.sendReplyBox('<div style = "padding: 8px; color: #7f5200; background: #000 url(http://farm4.static.flickr.com/3358/3503936537_d9b46321cd.jpg) no-repeat scroll bottom; background-size: 100%;">' +
