...
exports.commands = {
	...
	azh: function (target, room, user) {
		if (!this.runBroadcast()) return;
		this.sendReplyBox('<div style = "padding: 8px; background: #000 url(https://67.media.tumblr.com/1c8df8b90843d1f29c2daec235f20c3a/tumblr_o8chi3z52U1v5aa3xo1_1280.png) no-repeat scroll bottom; background-size: 100%;">' +
			...
			'<center><font size=2 color=#0000FF><b>Battle Theme</b> - <i>Hoenn Oceanic Museum Remix [Credits: GlitchXCity]</i></font><br \><audio src="https://dl.pushbulletusercontent.com/rd0Qhn6drs85cyLNk7XIxGmwLQHQl4q1/Atmosphere-%20Bright.mp3" controls="" border: 2px solid #76BCBE ; background-color: #76BCBE" target="_blank"></audio></center><br \>' +
			'<font size=1>P.S. All credits for artwork goes to Tempest (ABootToTheHead), sprite imaging to Showdown!, and avatar imaging to Reborn Sprite Gallery and corresponding artists!</font><br>' + getBadges('frontierzachary'));
	},
