...
var cmds = {
        ...
        help: function (target, room, user) {
                ...
                return this.sendReplyBox('<b>Custom Avatar commands<b><br>' +
                        ...
                        '<li>/ca set <small>or</small> /setavatar <em>User</em>, <em>URL</em> - Sets the specified user's avatar to the specified image link. Requires ~' +
	...
	set: function (target, room, user, connection, cmd) {
		...
		request.get(target).on('error', function() {
			...
			self.sendReply('|html|' + their + ' custom avatar has been set to <br><img src = "' + target + '" width = 80 height = 80>');
