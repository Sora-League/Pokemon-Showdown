var badgeList = {
	...
	goldrisu: ['Gold Cup Pachirisu', '<img src="http://i.imgur.com/ngrC6WP.png" width=75 height=75 title="Champion of the Internation Pokemon League (Season 3)">', '<img src="http://i.imgur.com/ngrC6WP.png">'],
	silverrisu: ['Silver Cup Pachirisu', '<img src="http://i.imgur.com/RQRENUa.png" width=75 height=75 title="Runner Up of the International Pokemon League (Season 3)">', '<img src="http://i.imgur.com/RQRENUa.png">'],
	landorus: ['Landorus', '<img src="http://i.imgur.com/VcxTNWj.png" width=75 height=75 title="Most Valuable Pokemon in Season 3 of the IPL">', '<img src="http://i.imgur.com/VcxTNWj.png">'],
	megaaltaria: ['Mega Altaria', '<img src="http://i.imgur.com/ueI4x5s.png" width=75 height=75 title="Top Pokèmon Killer in Season 3 of the IPL">', '<img src="http://i.imgur.com/ueI4x5s.png">']
};
